...
class RAGService:
    ...
    def search(self, query: str, collection_name: str, user_id: str, limit: int = 20, score_threshold: float = 0.0) -> List[SearchResult]:
    ...
    def rag(self, query: str, collection_name: str, user_id: str, limit: int = 20) -> RAGResponse:
        """完整的 RAG 流程：檢索並生成。"""
        try:
